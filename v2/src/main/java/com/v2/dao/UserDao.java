 ...
 /**
  ...
  /**
	...
	private User setUser(Map<String, Object> data) {
		...
		if (data.get("SALES_SUM") != null) 
			user.salesSum = (int) data.get("SALES_SUM");
		if (data.get("SALES_CASH_SUM") != null) 
			user.salesCashSum = (int) data.get("SALES_CASH_SUM");
		if (data.get("RECOMMENT_URL1") != null) 
			user.recommentUrl1 = (String) data.get("RECOMMENT_URL1");
		if (data.get("RECOMMENT_URL2") != null) 
			user.recommentUrl1 = (String) data.get("RECOMMENT_URL2");
		if (data.get("RECOMMENT_URL3") != null) 
			user.recommentUrl1 = (String) data.get("RECOMMENT_URL3");
